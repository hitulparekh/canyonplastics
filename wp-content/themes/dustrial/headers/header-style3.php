        ...
        <div class="col-lg-3 col-sm-6">
          <div class="logo">
            <?php
              ...
              if ( has_custom_logo() ) {
                echo '<a href="'.esc_url(home_url('/')).'" class="navbar-brand"><div class="h3-main-logo"><img src="'. esc_url( $logo[0] ) .'" alt="'.esc_attr__( 'Dustrial logo', 'dustrial' ).'"></div></a>';
              } elseif(function_exists( 'dustrial_framework_init' ) ) {
                $site_logo_id2  = dustrial_get_option('dustrial_logo2_img');
                $attachment2    = wp_get_attachment_image_src( $site_logo_id2, 'full' );
                $site_logo2     = ($attachment2) ? $attachment2[0] : $site_logo_id2;
                echo'<a href="'.esc_url(home_url('/')).'" class="navbar-brand">
                  <div class="h3-main-logo"><img alt="'.esc_attr__( 'Dustrial logo', 'dustrial' ).'" src="'.esc_url( $site_logo2 ).'"></div>
                </a>';
              } else {
          ...
          <div class="main-menu-area">
	        ...
	        <?php if(function_exists( 'dustrial_framework_init' ) ) {
	            ...
	            if ( !empty($menu_search_btn)) {
	              ...
	              $all_btn = $search_btn . ' ' . $cart_btn;
	            if ( !empty($menu_cart_switch) || !empty($menu_search_btn)) {
	            ?>
